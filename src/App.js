    ...
    <div className='main'>  
      ...
      <section className='skill-section' id='skill' >
        ...
        <div className='skill-desc'>
          ...
          <p className='skill-text' data-aos ="fade-up">In my journey, I have diligently strengthened every skill I possess. 
          From design to development, every step is part of my personal journey
          towards excellence. It reflects my commitment to continually grow and 
          ...
          <div className='skill-body'>
            ...
            <CardSkill role="Graphic Desainer" image={GraphicDesign}/>
